...
class Excel:
	def __init__(self):
		self.info, self.total_trades = self.fiks_data()
	...
	def hoved(self):
		...
		self.sheet.cell(row = self.skriv_rad, column = 1).value = self.total_trades
		self.wb.save("nov2021 2000.xlsx")
	...
	def fiks_data(self):
		...
		print()
		print(all_trades)
		return all_trades, total_trades
