...
class Start_up2():
	...
	def login(self):
		try:
			...
			pass
		self.driver.find_element_by_xpath("//input[@id='login']").send_keys("19848")
		self.driver.implicitly_wait(10)
		self.driver.find_element_by_xpath("//input[@id='password']").send_keys("Rehman5724")
		self.driver.implicitly_wait(10)
		self.driver.find_element_by_xpath("//select[@id='server']").click()
...
class kjop3():
	...
	def s_size(self):
		size = {'1': '0.01', '2': '0.02','3': '0.04', '4': '0.09', '5': '0.19', '6': '0.01', '7': '0.01', '8': '0.02', "9":"0.01", "10": '0.02',"11":"0.01", "12": '0.02',"13":"0.01", '14': '0.02',"15":"0.01", "17": "0.01","18":"0.02", "19": "0.01","20":"0.02"}
