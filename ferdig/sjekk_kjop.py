...
class Start_up():
	def __init__(self):
		...
		self.login()
		self.fiks_oppsett()
		self.demo2 = Start_up4()
		self.ekte = Start_up3()

		self.kjor = Start_program(self, self.driver, self.demo2, self.ekte)
	...
	def login(self):
		try:
			...
			pass
		self.driver.find_element_by_xpath("//input[@id='login']").send_keys("19436")
		self.driver.implicitly_wait(10)
...
class Start_program():
	def __init__(self, set_up, driver, demo2, ekte):
		self.set_up = set_up
		self.driver = driver
		self.demo2 = demo2
		self.ekte = ekte
	...
	def hoved(self):
		...
		if fortsett:
			with open(f"valutaer/0_size.txt","r") as s:
				lot = s.read()
			trend = self.demo2.sjekk_chart()
			if True:
				self.ekte.kjor.hoved(trend)
			else:
				self.demo2.kjor.hoved()
...
class Start_up3():
	...
	def login(self):
		try:
			...
			pass
		self.driver.find_element_by_xpath("//input[@id='login']").send_keys("19438")
		self.driver.implicitly_wait(10)
		self.driver.find_element_by_xpath("//input[@id='password']").send_keys("Rehman5724")
		self.driver.implicitly_wait(10)
		self.driver.find_element_by_xpath("//select[@id='server']").click()
...
class kjop3():
	...
	def s_size(self):
		size = {'1': '0.01', '2': '0.02','3': '0.04', '4': '0.09', '5': '0.19', '6': '0.01', '7': '0.01', '8': '0.01', "9":"0.01", "10": '0.01',"11":"0.01", "12": '0.01',"13":"0.01", '14': '0.01',"15":"0.01", "17": "0.01","18":"0.01", "19": "0.01","20":"0.01"}
...
class Start_up4():
	...
	def login(self):
		...
		time.sleep(1)
		self.driver.find_element_by_xpath("//input[@name='username']").send_keys("moh0802@hotmail.com")
		time.sleep(1)
